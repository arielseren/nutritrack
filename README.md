...
- ⚡ **הזנה ישירה של קלוריות ומאקרו ללא חישוב 100 גרם (Direct Macro & Meal Logging):** אפשרות להזין ישירות את סך הקלוריות, החלבון, הפחמימות והשומן של המנה ולהוסיף מיד ליומן ללא חישובי גרמים או מאזניים.
