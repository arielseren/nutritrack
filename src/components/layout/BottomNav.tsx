...
import { LayoutDashboard, BookOpen, PlusCircle, BookMarked, User } from 'lucide-react';
...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-surface-container-lowest/95 backdrop-blur-lg border-t border-surface-container-high shadow-[0_-4px_24px_0_rgba(0,107,95,0.06)] py-1.5 px-4">
      <div className="w-full max-w-[480px] mx-auto flex items-center justify-between">
        ...
        >
          ...
          <span className="text-[11px] mt-0.5">לוח בקרה</span>
        </button>
