...
export const CreateMealPlanModal: React.FC<CreateMealPlanModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-4 animate-in fade-in duration-200">
      <div className="bg-surface rounded-t-3xl sm:rounded-3xl w-full max-w-[480px] sm:max-w-2xl h-[94dvh] sm:h-[88dvh] sm:max-h-[90dvh] flex flex-col shadow-2xl border border-surface-container-high overflow-hidden animate-modal-sheet modal-safe-bottom">
