...
16. **מדריך למשתמש אינטראקטיבי בתוך האפליקציה (Interactive In-App User Guide):**
    - כפתור מדריך ייעודי בראש מסך הפרופיל (📖) עם 11 פרקים מקיפים, אקורדיונים, הסברים מפורטים על כל יכולות ה-AI, יועצי התזונה (איתי ומאיה), שקילות, אימונים וחיפוש טקסטואלי מהיר בזמן אמת.
