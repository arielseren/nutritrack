...
│   │   ├── storageService.ts     # שירות שמירת LocalStorage, גיבויים, שקילות, משתמשים ותפריטים מותאמים
...
│   │   ├── dashboard/
│   │   │   ├── DashboardView.tsx # דף הבית הראשי, באנר אימונים קומפקטי עם כפתור שינוי, ווידג'ט מעקב משקל
